...
import ntustee610.onvif_client_v2.ONVIF_Method.PlayVideoFromServer;
import veg.mediaplayer.sdk.MediaPlayer;

/**
 * Created by weihsun on 2017/4/20.
 */

public class PlayerCallBacks2 implements MediaPlayer.MediaPlayerCallback{
    private PlayVideoFromServer act;
...
//                    Log.e(TAG, "PLP_EOS: " +act.isFileUrl + ", " + player.getState());
    ...
    public PlayerCallBacks2(PlayVideoFromServer act, MediaPlayer player){
        this.act = act;
        this.player = player;
    }
