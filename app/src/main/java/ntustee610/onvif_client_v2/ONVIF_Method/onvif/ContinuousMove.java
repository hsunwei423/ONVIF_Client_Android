...
public class ContinuousMove {
    SoapObject result_ContinuousMove = null;
    ...
    public ContinuousMove(String getURI, double x, double y, double z, String profileName, String userName, String password){
        try {
            ...
            result_ContinuousMove = (SoapObject) soapEnvelope.getResponse();   //getResponse from the IP-CAMERA
        } catch (Exception ex) {
            Log.e("result_ContinuousMove", "Error: " + ex.getMessage());
        }
    }

    public SoapObject getContinuousMoveResponse(){
        return result_ContinuousMove;
    }
