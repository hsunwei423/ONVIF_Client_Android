...
public class Stop {
    ...
    public Stop(String getURI, String PT, String Z, String profileName, String userName, String password){
        try {
    ...
    public SoapObject getStopResponse(){
        return result_Stop;
    }
